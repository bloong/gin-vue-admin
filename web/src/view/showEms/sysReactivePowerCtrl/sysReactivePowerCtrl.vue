      ...
      <el-card class="form-card" shadow="never">
        ...
        <el-form-item prop="input_active_power_r">
          <div class="flex gap-4">
            <span class="span">Q<sub>R</sub></span>
            <el-input
            ...
            />
            <el-tooltip content="远程设置无功功率(MW)" placement="top">
        ...
        <el-form-item prop="input_active_power_L">
          <div class="flex gap-4">
            <span class="span">Q<sub>L</sub></span>
            <el-input
              ...
              s
            />
            <el-tooltip content="本地设置无功功率(MW)" placement="top">
              <el-icon><InfoFilled /></el-icon>
            </el-tooltip>
          </div>
        </el-form-item>
