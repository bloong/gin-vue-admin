      ...
      <el-card class="form-card" shadow="never">
        ...
        <el-form-item prop="input_fd">
          <div class="flex gap-4">
            ...
            />
            <el-tooltip content="惯量支撑频率死区" placement="top">
              <el-icon><InfoFilled /></el-icon>
            </el-tooltip>
          </div>
        </el-form-item>

        <el-form-item prop="input_derta">
          <div class="flex gap-4">
            ...
            <el-input
              ...
              :disabled="formData.select_onoff !== 1"
            />
            <el-tooltip content="惯量支撑频率变化率" placement="top">
              <el-icon><InfoFilled /></el-icon>
            </el-tooltip>
          </div>
        </el-form-item>

        <el-form-item prop="input_a">
          <div class="flex gap-4">
            <span class="span">α</span>
            <el-input
              v-model="formData.input_a"
              type="text"
              :minlength="1"
              :maxlength="7"
              :disabled="formData.select_onoff !== 1"
            />
            <el-tooltip content="惯量支撑功率限幅系数" placement="top">
              <el-icon><InfoFilled /></el-icon>
            </el-tooltip>
          </div>
        </el-form-item>

        <el-form-item prop="input_t">
          <div class="flex gap-4">
            <span class="span">t</span>
            <el-input
              v-model="formData.input_t"
              type="text"
              :minlength="1"
              :maxlength="7"
              :disabled="formData.select_onoff !== 1"
            />
            <el-tooltip content="惯量支撑时间常数" placement="top">
              <el-icon><InfoFilled /></el-icon>
            </el-tooltip>
          </div>
        </el-form-item>
